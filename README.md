...
---
PROV-IO is a provenance tracking & management framework for scientific data I/O libraries. It provides a interface for provenance tracking based on an I/O-centric, [W3C PROV-DM](https://www.w3.org/TR/prov-dm/)-compliant [provenance model](https://github.com/hpc-io/prov-io/blob/master/doc/provio-latest.png) and stores & manages data provenance as RDF triples. PROV-IO can be used to track HDF5 workload provenance with [HDF5 vol-provenance connector](https://github.com/hpc-io/vol-provenance). PROV-IO has been tested on Ubuntu 18.04.1 and Cray Linux (Cori at NERSC/LBNL).
